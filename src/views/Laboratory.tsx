...
export const Laboratory: React.FC = () => {
  ...
  const [selectedOrder, setSelectedOrder] = useState<LaboratorioOrden | null>(
    null,
  );
  ...
  const handleFinalize = async () => {
    ...
    try {
      ...
      toast.success(
        `Resultados de ${selectedOrder.ficha.mascota.nombre} guardados con éxito`,
      );
      ...
      <header className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400">
            Panel de procesamiento de muestras
          </p>
        </div>
          ...
          {selectedOrder ? (
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold">
                      {selectedOrder.ficha.mascota.nombre}
                    </h3>
                    <p className="text-slate-400 text-sm">
                      Examen:{" "}
                      <span className="text-primary font-bold">
                        {selectedOrder.examen.nombre}
                      </span>{" "}
              ...
              <div className="p-8 space-y-6">
                <div className="grid grid-cols-2 gap-6 p-4 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800">
                  <div>
                    ...
                    <p className="font-bold">
                      {selectedOrder.examen.tipo_muestra || "No especificada"}
                    </p>
                  </div>
                  <div>
                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">
                    ...
                    <p className="font-bold">
                      {selectedOrder.ficha.doctor?.nombre || "Ingreso Directo"}
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setResult({ ...result, hallazgos: e.target.value })
                    }
                  />
                </div>
                ...
                <div className="flex justify-end gap-4 pt-6 border-t border-slate-100 dark:border-slate-800">
                  <button
                    ...
                    className="px-6 py-2.5 rounded-lg text-slate-500 font-bold text-sm hover:bg-slate-50 transition-colors"
                  >
                    Cancelar
                  </button>
                  <button
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-xl p-12 flex flex-col items-center justify-center text-center h-[500px]">
              ...
              <p className="text-slate-500 dark:text-slate-400 mt-2 max-w-xs">
                Selecciona una orden de la cola para comenzar a registrar los
                resultados.
              </p>
            </div>
          )}
        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
            ...
            >
              ...
              <form
                onSubmit={handleCreateDirectOrder}
                className="p-8 space-y-6"
              >
                {/* Buscador de mascota */}
                <div className="space-y-2">
                  <label className="text-xs font-black text-slate-500 uppercase tracking-widest">
                    Paso 1: Identificar Mascota *
                  </label>
                  ...
                  <p className="text-[10px] text-slate-400 italic">
                    Si la mascota no aparece, regístrala primero en el módulo de
                    Clínica.
                  </p>
                </div>
